...
const tourSchema = new mongoose.Schema(
  {
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        message:
          'Discount price ({VALUE}) must be less than the price of the tour',
      },
    },
    summary: {
      type: String,
...
//modal names are always capitalized (better to understand it is a modal)
