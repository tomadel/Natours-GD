...
})({"7LaUj":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
...
const loginForm = document.querySelector(".form--login"); // Add this line to select the login form
...
if (loginForm) loginForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const email = document.getElementById("email").value; // Move this line inside the event listener
...
if (bookBtn) bookBtn.addEventListener("click", (e)=>{
    ...
    const { tourId  } = e.target.dataset; // Add this line to get the tourId from the dataset
    (0, _stripe.bookTour)(tourId);
});

},{"@babel/polyfill":"@babel/polyfill","./leaflet":"58ZVV","./login":"qZEOz","./updateSettings":"28JcJ","./stripe":"hu9K2"}],"58ZVV":[function(require,module,exports) {
/* eslint-disable */ // Get locations from HTML
...
},{"axios":"axios","./alerts":"j4hQk","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"hu9K2":[function(require,module,exports) {
/*eslint-disable*/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const bookTour = async (tourId)=>{
    const stripe = Stripe("pk_test_51N12yZDdtcZJgpwWKLs4LEkzAMHdmVkoFoONms7sEqlNfdKLjfy4FmECtl4XKVJlzC3To1weDi4Zip4LOrTzYlND00hdaql1q8");
    try {
...
},{"axios":"axios","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}]},["7LaUj","4uyBp"], "4uyBp", "parcelRequire11c7")
